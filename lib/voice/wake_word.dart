...
class WakeWordService {
  ...
  static const modelUrl = 'https://github.com/k2-fsa/sherpa-onnx/releases/'
  ...
  void feed(Uint8List pcmChunk) {
    ...
    try {
      _stream!.acceptWaveform(
          samples: pcmBytesToFloat32(pcmChunk), sampleRate: 16000);
...
Future<bool> ensureKwsModel(String modelDir) async {
  ...
  try {
    ...
    final result = await Process.run(
        'tar', ['-xf', archive.path, '-C', modelDir, '--strip-components=1']);
