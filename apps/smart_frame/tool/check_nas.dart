...
// 与 apps/smart_frame/lib/features/photos/application/photo_service.dart / nas_filter.dart 保持一致，避免 import
...
Future<void> _walk(
  ...
  String dir,
  void Function(String path, bool isDir) emit,
) async {
